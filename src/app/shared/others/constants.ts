...
/* ---------------     Node server ------------ */
  ...
  export const REST_API_URL_NODE = 'http://localhost:4000';
//export const isLive = true;
//export const REST_API_URL_NODE = 'http://192.140.153.250:4000';
//export const REST_API_URL_NODE = 'http://139.59.6.52:4000';
