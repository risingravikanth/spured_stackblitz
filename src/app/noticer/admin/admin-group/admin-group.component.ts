...
@Component({
  ...
  providers: [MobileDetectionService, CurrentUserService, SideMenuService, AdminGroupService, ToastrService]
})
export class AdminGroupComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private mobileService: MobileDetectionService, private userService: CurrentUserService,
    private leftMenuService: SideMenuService, private service: AdminGroupService, private toastr: ToastrService,
