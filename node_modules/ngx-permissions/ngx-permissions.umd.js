(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/BehaviorSubject'), require('rxjs/Observable'), require('rxjs/add/observable/of'), require('rxjs/add/observable/throw'), require('rxjs/add/operator/first'), require('rxjs/add/operator/catch'), require('rxjs/add/operator/toPromise'), require('rxjs/add/operator/mergeAll'), require('rxjs/add/observable/merge'), require('rxjs/add/observable/from'), require('rxjs/add/operator/every'), require('rxjs/add/operator/merge'), require('rxjs/add/operator/skip'), require('@angular/router'), require('rxjs/add/observable/forkJoin'), require('rxjs/add/operator/mergeMap'), require('rxjs/add/operator/do'), require('rxjs/add/operator/map')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs/BehaviorSubject', 'rxjs/Observable', 'rxjs/add/observable/of', 'rxjs/add/observable/throw', 'rxjs/add/operator/first', 'rxjs/add/operator/catch', 'rxjs/add/operator/toPromise', 'rxjs/add/operator/mergeAll', 'rxjs/add/observable/merge', 'rxjs/add/observable/from', 'rxjs/add/operator/every', 'rxjs/add/operator/merge', 'rxjs/add/operator/skip', '@angular/router', 'rxjs/add/observable/forkJoin', 'rxjs/add/operator/mergeMap', 'rxjs/add/operator/do', 'rxjs/add/operator/map'], factory) :
	(factory((global['ngx-permissions'] = global['ngx-permissions'] || {}),global._angular_core,global.rxjs_BehaviorSubject,global.rxjs_Observable,null,null,null,null,null,null,null,null,null,null,null,global._angular_router));
}(this, (function (exports,_angular_core,rxjs_BehaviorSubject,rxjs_Observable,rxjs_add_observable_of,rxjs_add_observable_throw,rxjs_add_operator_first,rxjs_add_operator_catch,rxjs_add_operator_toPromise,rxjs_add_operator_mergeAll,rxjs_add_observable_merge,rxjs_add_observable_from,rxjs_add_operator_every,rxjs_add_operator_merge,rxjs_add_operator_skip,_angular_router) { 'use strict';
...
var NgxPermissionsService = /** @class */ (function () {
    ...
    NgxPermissionsService.prototype.hasArrayPermission = function (permissions) {
        ...
        return rxjs_Observable.Observable.merge(promises)
            .mergeAll()
            .first(function (data) {
            return data !== false;
...
var NgxRolesService = /** @class */ (function () {
    ...
    NgxRolesService.prototype.hasRoleKey = function (roleName) {
        ...
        return rxjs_Observable.Observable.merge(promises).mergeAll().first(function (data) {
            return data !== false;
