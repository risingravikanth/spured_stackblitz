...
var NgxRolesService = /** @class */ (function () {
    ...
    NgxRolesService.prototype.hasRoleKey = function (roleName) {
        ...
        return Observable.merge(promises).mergeAll().first(function (data) {
            return data !== false;
...
export { NgxPermissionsModule, NgxPermissionsAllowStubModule, NgxPermissionsRestrictStubModule, NgxRolesStore, NgxPermissionsStore, NgxPermissionsDirective, USE_PERMISSIONS_STORE, NgxPermissionsService, USE_ROLES_STORE, NgxRolesService, NgxPermissionsGuard, NgxRole, NgxPermissionsAllowStubDirective, NgxPermissionsRestrictStubDirective };
